...
TCPDirectSensor::TCPDirectSensor()
{
#ifdef HD
	colorWidth = 1280;
	colorHeight = 720;
...
HRESULT TCPDirectSensor::createFirstConnected()
{
	WSADATA wsaData;
	int iRet = 0;
...
HRESULT TCPDirectSensor::processDepth()
{
...
HRESULT TCPDirectSensor::processColor()
{
...
void TCPDirectSensor::quaternion2Mat(float* quaternion)
{
